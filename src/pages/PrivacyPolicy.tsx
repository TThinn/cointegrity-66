        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Who is responsible for data processing and whom can you contact?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. What data is processed and from which sources does this data originate?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. For what purposes and on what legal basis is the data processed?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. Who receives your data?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">5. How long will your data be stored?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">6. What data protection rights do you have?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">7. Are you required to provide data?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">8. To what extent is there automated decision-making (including profiling)?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">9. To what extent does your data help to make decisions in individual cases?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">10. Will the personal data be transferred to a third country?</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">11. Application Data</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">13. Cookies and Tracking Tools</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">14. Use of social sharing</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">15. Contact via website</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">16. Embedding of YouTube videos</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">17. Use of Google reCaptcha</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">18. Use of Google Maps</h2>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">19. Google Tag Manager</h2>
