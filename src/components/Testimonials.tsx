      ...
      <Container>
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fade-up">
            <h2 className="text-sm text-blue-400 uppercase tracking-wider font-medium">CLIENT TESTIMONIALS</h2>
          ...
          <div className="mt-10 text-center animate-fade-up">
            <a href="#contact">
              <Button variant="cta-primary" size="md" className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700">Join the Good Company</Button>
            </a>
          </div>
        </div>
      </Container>
