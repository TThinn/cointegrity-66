    ...
    <section id="testimonials" className="py-20 relative overflow-hidden" ref={sectionRef}>
      ...
      <Container>
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {/* Using relative positioning for proper stacking, but removing the height constraint */}
          <div className="transition-all duration-300 relative z-30">
              ...
              {[0, 1, 2, 3].map(position => (
                <div 
                  ...
                  className={`glass bg-white/5 backdrop-blur-md border border-white/10 p-8 shadow-lg transition-all duration-300 relative z-30 
                    ...
                    ${hoveredCard === position ? 'transform -translate-y-2 shadow-xl border-white/20' : ''}`}
