...
const PARTICLE_VERTICAL_SPREAD = 10; // percent of section height above/below button
...
const Testimonials = () => {
  ...
  // Position particles relative to button center
  useLayoutEffect(() => {
  ...
  const particles = useMemo(() => {
    ...
    return Array.from({ length: particleCount }, () => {
      // Distribute y equally above and below button center
      const spread = PARTICLE_VERTICAL_SPREAD;
      return {
        size: 20 + Math.random() * 60,
        x: ctaPosition.x - 10 + Math.random() * 20, // ±10% horizontally
        y: ctaPosition.y - spread + Math.random() * (2 * spread), // ±spread% vertically
  ...
  // Max height for layout stability
  useEffect(() => {
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mt-5 text-center animate-fade-up relative">
            <div className="inline-block relative">
              ...
              >
                <Button variant="cta-primary" size="md">
                  Partner with us
                </Button>
              </a>
            </div>
