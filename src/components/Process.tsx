        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {processSteps.map((step, index) => (
              <div 
                key={step.id} 
                className="group relative glass bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-xl transition-all duration-500 hover:bg-white/10 hover:scale-[1.02] hover:shadow-xl hover:shadow-pink-500/10"
