...
const Process = () => {
  ...
  return (
    <section id="process" className="py-24 relative overflow-hidden bg-[#080112]">
      ...
      <Container>
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fade-up">
            ...
            <h3 className="text-3xl md:text-4xl font-bold mb-2 text-gray-200">Your Journey to Web3 Success</h3>
            <p className="text-gray-400 max-w-2xl mx-auto">A structured approach to transform your business focusing on delivering maximum value</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {processSteps.map((step, index) => (
              ...
              >
                <div className="process-number absolute -top-6 -left-6 w-12 h-12 rounded-full flex items-center justify-center">
          ...
          <div className="neo-box flex flex-col md:flex-row items-center justify-between gap-8 p-8 backdrop-blur-md relative">
            <div className="text-center md:text-left relative z-10">
              <h4 className="text-xl font-bold text-gray-200 mb-2">Ready to Shape the Future of Finance?</h4>
              <p className="text-gray-400">Our experts are ready to guide you through the next steps of your Web3 journey.</p>
            </div>
