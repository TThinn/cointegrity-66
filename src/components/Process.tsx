...
import { ArrowRight, MapPin, Zap, Shield, Award } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fade-up">
            ...
            <p className="text-white/60 max-w-2xl mx-auto">
              A structured approach to transform your business and position you at the forefront of the future of finance
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {processSteps.map((step, index) => (
              <div 
                key={step.id} 
                className="group relative glass bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-xl transition-all duration-500 hover:bg-white/10 hover:scale-[1.02] hover:shadow-xl hover:shadow-pink-500/10 overflow-visible"
                style={{ animationDelay: `${0.1 + index * 0.1}s` }}
              >
                {/* Modified circle positioning */}
                <div className="absolute -top-6 -left-6 w-12 h-12 rounded-full bg-gradient-to-br from-[#120825] to-[#1D0D35] flex items-center justify-center border border-pink-400/30 z-10">
