...
const services = [{
  ...
  items: ["Investor Network Access (%)", "Market Making", "Strategic Funding Preparation", "Grants", "Pitch Coaching", "Colateral", "Data Room"],
  color: "violet"
}];
const Services = () => {
  return <section id="services" className="py-20 bg-gradient-to-b from-[#fbf9ff] to-[#fdf5fa] relative">
      <Container>
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600">Our typical clients are spread across a diverse range of industries, including governmental agencies, global consulting firms, launch platforms, gaming companies, Virtual Asset Service Providers (VASPs), and more.</p>
        </div>
