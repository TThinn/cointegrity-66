...
const services = [
  {
    ...
    description:
      "Custom smart contract development and auditing, dApp development and Web3 infrastructure setup to power your decentralized vision.",
  },
  {
    icon: <Lightbulb size={24} className="text-blue-600" />,
    title: "Strategic Consulting",
    description:
      "Expert guidance on Web3 transformation, tokenomics design, and blockchain integration strategies for your business.",
  },
  {
    icon: <BarChart3 size={24} className="text-purple-600" />,
    title: "DeFi Solutions",
    description:
      "End-to-end DeFi platform development, protocol design, and yield optimization strategies to maximize your financial offerings.",
  },
  {
    icon: <Shield size={24} className="text-blue-600" />,
    title: "Security & Compliance",
    description:
      "Comprehensive security audits, risk assessments, and regulatory compliance frameworks tailored for blockchain businesses.",
  },
];
    ...
    <section id="services" className="py-20 bg-white relative">
      <Container>
        ...
        <div className="mt-16 flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-16 p-8 md:p-10 rounded-2xl bg-gradient-to-r from-purple-50 to-blue-50">
          ...
          <a 
            href="#contact" 
            className="inline-flex items-center px-6 py-3 rounded-lg bg-purple-blue-gradient text-white font-medium shadow-button hover:shadow-lg transition-all"
          >
