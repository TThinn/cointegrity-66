...
import { CTA_PARTICLE_COUNT_DESKTOP, CTA_PARTICLE_COUNT_MOBILE } from "./processData";
...
const ProcessCTA: React.FC = () => {
  ...
  // Update CTA position when component renders or window resizes
  useLayoutEffect(() => {
  ...
  return (
    ...
    >
      ...
      <a href="#contact" className="inline-flex items-center relative z-10" ref={ctaRef}>
        <button 
          className="bg-white/15 backdrop-blur-sm text-white px-6 py-3 rounded-full
