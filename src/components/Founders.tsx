  ...
  return <section id="founders" className="py-20 bg-gradient-to-b from-[#fbf9ff] to-[#fdf5fa] relative">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {founders.map((founder, index) => <div key={index} className="team-card p-6 backdrop-blur-sm hover:translate-y-[-4px] transition-all duration-300 text-center rounded-lg bg-white/20" style={{
