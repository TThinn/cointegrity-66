...
const Founders = () => {
  return <section id="founders" className="py-20 bg-gradient-to-b from-white to-purple-50">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          animationDelay: `${0.1 + index * 0.1}s`
              ...
              <div className="relative mb-4 w-24 h-24 overflow-hidden rounded-full">
                <div className="absolute inset-0 bg-purple-blue-gradient opacity-10 rounded-full"></div>
