    ...
    <section className="hero-section pt-32 pb-16 lg:pt-40 lg:pb-24 relative overflow-hidden bg-[#080112]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 z-[1] pointer-events-none">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(225,29,143,0.1)_0%,_transparent_70%)] animate-light-pulse"></div>
          <div className="absolute inset-0 bg-[linear-gradient(0deg,_transparent_45%,_rgba(225,29,143,0.08)_50%,_transparent_55%)] animate-light-sweep"></div>
        </div>
      </div>
