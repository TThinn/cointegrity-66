  ...
  return (
    <section className="hero-section pt-32 pb-16 lg:pt-40 lg:pb-24 relative overflow-hidden bg-[#080112] isolate">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        {/* New light effects layer */}
        <div className="absolute inset-0 z-[1] pointer-events-none">
          {/* Layer 1 - Primary diagonal sweep */}
          <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_45%,rgba(225,29,143,0.04)_50%,transparent_55%)] animate-light-sweep mix-blend-screen"></div>
          
          {/* Layer 2 - Secondary diagonal sweep */}
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_60%_40%,rgba(225,29,143,0.5)_0%,transparent_70%)] animate-light-pulse mix-blend-screen"></div>
        </div>
      </div>
      ...
      <style jsx global>{`
        ...
        .animate-light-pulse {
          animation: light-pulse 8s infinite ease-in-out;
        }
