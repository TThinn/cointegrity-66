...
const Hero = () => {
  ...
  return (
    <section id="Web3-Consulting" className="hero-section relative overflow-hidden bg-[#060115] isolate min-h-screen flex items-center justify-center">
      {/* Background elements */}
      ...
      <Container className="hero-content relative z-8 text-lg font-normal">
