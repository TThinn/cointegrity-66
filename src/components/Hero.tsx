  ...
  return <section className="hero-section pt-32 pb-16 lg:pt-40 lg:pb-24 relative overflow-hidden bg-[#060115] isolate">
    ...
    <Container className="hero-content relative z-8 text-lg font-normal flex flex-col min-h-[70vh] justify-between">
      <div className="flex flex-col items-center text-center max-w-4xl mx-auto mt-16">
        <h1 style={{
          animationDelay: "0.2s"
        }} className="text-[32px] lg:text-[50px] tracking-tight text-balance animate-fade-up mb-8 font-normal leading-tight text-shadow">
          <span data-text="Strategic Web3 Advisory for" className="text-white font-normal">Simplifying Web3 Complexity</span>{" "}
          {" "}
          {" "}
          {" "}
        ...
        <h2 className="text-lg max-w-2xl text-balance animate-fade-up relative mb-16 text-white/80" style={{
          animationDelay: "0.4s"
        }}>We provide Full-cycle Web3 Consulting Solutions in the Intersection of Blockchain, Ai, Tax &amp; Compliance.</h2>
      </div>
