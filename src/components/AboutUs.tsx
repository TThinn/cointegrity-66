...
const AboutUs = () => {
  ...
  const particles = useMemo(() => {
    ...
    return Array.from({
      ...
      'rgba(147,51,234,0.5)'][Math.floor(Math.random() * 4)]
    }));
        ...
        <div className="flex flex-col md:flex-row gap-10 mb-16">
          ...
          <div className="w-full md:w-2/5 text-center md:text-left">
            ...
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-gray-800 leading-tight">
              Trusted Web3 Experts Bridging Traditional Business with Blockchain Innovation
            </h3>
          ...
          <div className="w-full md:w-3/5 text-gray-600 text-center md:text-left">
            <p className="mb-4">
              We transform traditional businesses into <strong>Web3 leaders</strong> through proven blockchain solutions that significantly <strong>reduce costs</strong> and <strong>accelerate time-to-market</strong>. Our expertise spans{" "}
              <Link to="/services" className="text-[#cb46b3] hover:text-[#cb46b3]/80 underline transition-colors">
                strategic positioning
              </Link>, decentralized product development, go-to-market strategies, AI-powered solutions, <strong>Regulatory & Tax Compliance</strong>, and{" "}
              <Link to="/services#capital-acceleration" className="text-[#cb46b3] hover:text-[#cb46b3]/80 underline transition-colors">
                growth capital
              </Link> - delivering solutions that simplify complexity and amplify opportunity.
            </p>
            <p className="mb-4">
              Eliminate regulatory headaches and technical barriers with our <strong>battle-tested blockchain integration</strong> framework. Whether you're launching a token, building a compliant platform, or seeking funding for your <strong>Web3 initiative</strong>, our{" "}
              <Link to="/team" className="text-[#cb46b3] hover:text-[#cb46b3]/80 underline transition-colors">
                expert team
              </Link>{" "}
              guides you through the entire <strong>digital transformation</strong> journey.
            </p>
            <p>
              Sleep soundly knowing your Web3 project combines <strong>cutting-edge innovation</strong> with <strong>bulletproof compliance</strong>, striking the perfect balance between innovation and compliance, opportunity and security, vision and execution. See what our{" "}
