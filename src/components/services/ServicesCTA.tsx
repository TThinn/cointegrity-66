...
const ServicesCTA = () => {
  ...
  return (
    <div 
      ref={ctaSectionRef}
     className="mt-16 flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-16 p-6 md:p-7 rounded-lg backdrop-blur-sm transition-all duration-300 bg-white/20 border border-white/70"
      style={{ 
      boxShadow: "0 4px 15px rgba(0, 0, 0, 0.05)",
      position: "relative",
      overflow: "hidden",
      minHeight: "100px"  // Reduced from 140px by ~30%
      }}
    >
      {/* Content */}
